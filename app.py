...
def signup():
    if request.method == 'POST':
        ...
        cursor.execute('''INSERT INTO users (first_name, last_name, email, password, dob, role, Created_date, Update_date) 
                          VALUES (%s, %s, %s, %s, %s, %s, %s, %s)''', 
                       (first_name, last_name, email, password, dob, role, Created_date, Update_date ))
        connection.commit()
        cursor.close()
        connection.close()
